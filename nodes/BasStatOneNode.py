...
class BasStatOneNode(polyinterface.Node):
    ...
    drivers = [
        ...
        {'driver': 'GV14',  'value': 'self.setsch', 'uom': 25}, # Virtual Value VT-3 Schedual
        {'driver': 'GV15', 'value': 'self.setfan', 'uom': 25}, # Virtual Value VT-4 Fan Enable
        {'driver': 'GV16', 'value': 1, 'uom': 25}, # Virtual Value VT-5 Heat Enable
        {'driver': 'GV17', 'value': 1, 'uom': 25}, # Virtual Value VT-6 Cool Enable
        {'driver': 'GV18', 'value': 'self.setaux', 'uom': 25}, # Virtual Value VT-7 Aux Enable
