...
class BasStatOneNode(polyinterface.Node):
    ...
    def cmdOn3(self, command):
        self.setaux1 = int(command.get('value'))
        self.setDriver("GV21", self.setaux1, force=True) 
        if self.setaux1 == 1:
    ...
    drivers = [
        ...
        {'driver': 'GV4', 'value': 1, 'uom': 17}, # Outside Air Temp float
