...
class BasStatOneNode(polyinterface.Node):
    ...
    def cmdOn1(self, command):
        self.setting = command.get('value')
        self.setDriver("GV14", self.setting)
        if self.setting == 1:
    ...
    def cmdOn2(self, command):
        self.setting = command.get('value')
        self.setDriver("GV15", self.setting) 
        if self.setting == 1:
    ...
    def modeOn(self, command):
        ...
        self.setDriver('GV19', self.modeOn)
        if self.modeOn == 0:
    ...
    drivers = [
        ...
        {'driver': 'GV12', 'value': 0, 'uom': 17},
        {'driver': 'GV13', 'value': 0, 'uom': 17},
        {'driver': 'GV14', 'value': 0, 'uom': 25},
        #{'driver': 'GV15', 'value': 0, 'uom': 25},
        {'driver': 'GV16', 'value': 0, 'uom': 80},
        {'driver': 'GV17', 'value': 0, 'uom': 80},
