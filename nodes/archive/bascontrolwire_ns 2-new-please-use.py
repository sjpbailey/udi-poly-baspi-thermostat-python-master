...
class Device:
    ...
    def readObject(self , iIndex):
        ...
        if not self.online:
            ...
            ### Raise an exception. ### instead of raising error retval 08_19_2020
            #raise IOError 
            ### NOT REACHED
        ### And return.
        return retval 
    ...
    def writeObject(self , iIndex , value):
        ...
        try:
            ...
            if (rsp.status_code == 200):
                ...
                ##if root.attrib['rsp'] == 'ack':    all with ## are to override wiresheet lockout!
        ...
        if not self.online:
            ...
            self.nextRetry = int(time.time())+self.retryInterval
            ### Raise an exception. ### instead of raising error retval 08_19_2020
            #raise IOError ### STOPPED NODE SERVER
            ### NOT REACHED
        ### And return.
        return retval
...
# contemporary controls / Universal devices, sjb 7/2019
